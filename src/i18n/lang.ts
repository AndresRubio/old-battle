...
const OPTION_ES: Record<string, string> = {
  Shield: 'Escudo',
  Shields: 'Escudos',
  'Shields (both crew)': 'Escudos (ambos tripulantes)',
  'Light armour': 'Armadura ligera',
  'Crew light armour': 'Armadura ligera (dotación)',
  'Heavy armour': 'Armadura pesada',
  'Heavy armour (both crew)': 'Armadura pesada (ambos tripulantes)',
  ...
  'Longbows (both crew)': 'Arcos largos (ambos tripulantes)',
  ...
  'Lances (both crew)': 'Lanzas (ambos tripulantes)',
